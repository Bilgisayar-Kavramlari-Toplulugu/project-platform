# BKT Platform Projesi Wiki'sine Hoş Geldiniz (Örnek)

<details open> <summary><strong>🇹🇷 Türkçe</strong></summary> <br>

Bu alan, **BKT Platform** projesinin yaşayan dokümantasyon merkezidir. Projenin mimarisi, tasarım kararları ve uzun vadeli bilgileri burada yer alacaktır.

👤 **Proje Lideri:** @flovearth  
👥 **Takım:** [platform Üyeleri](https://github.com/orgs/Bilgisayar-Kavramlari-Toplulugu/teams/platform)
---
...
- **[Issue Takip Panosu](https://github.com/Bilgisayar-Kavramlari-Toplulugu/project-platform/issues)**: Mevcut görevleri ve hataları görmek için.
- **[Proje Panosu](https://github.com/Bilgisayar-Kavramlari-Toplulugu/project-platform/projects)**: Projenin genel yol haritasını görmek için.
...
This is the living documentation hub for the **BKT Platform** project. The project's architecture, design decisions, and long-term information will reside here.


👤 **Project Lead:** @flovearth  
👥 **Team:** [platform Members](https://github.com/orgs/Bilgisayar-Kavramlari-Toplulugu/teams/platform)
...
- **[Issue Tracker](https://github.com/Bilgisayar-Kavramlari-Toplulugu/project-platform/issues)**: To see current tasks and bugs.
- **[Project Board](https://github.com/Bilgisayar-Kavramlari-Toplulugu/project-platform/projects)**: To see the overall project roadmap.
